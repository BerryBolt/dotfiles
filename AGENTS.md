...
- Deliver coherent atomic commits and push candidate commits to an implementation branch for VM testing through the public GitHub repository. Installer and chezmoi source must use the same full commit SHA. Follow PLAN for the loop; do not substitute an uncommitted copy of the working tree.
